...
const WebEngine = function(notary, storage, debug) {
    const handlers = {
        names: {
...
WebEngine.prototype = Object.create(HTTPEngine.prototype);
WebEngine.prototype.constructor = WebEngine;
exports.WebEngine = WebEngine;
